        ...
        <div class="row"> 
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">    
                        <div class="collapse navbar-collapse" id="navbarText">
                            <ul class="navbar-nav mr-auto">
                                <!-- liste question --> 
                                <li class="nav-item">   
                                   <button value="liste_question" class="bg-info ml-3 nav" >
                                ...
                                <!-- créer d'admin--> 
                                <li class="nav-item">
                                    <button value="inscription" class="bg-info ml-3 nav" >
                                ...
                                <!-- liste joueur --> 
                                <li class="nav-item">
                                    <button value="joueur" class="bg-info ml-3 nav">
                                        <svg class="bi bi-list" width="60px" height="60px" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"> 
                                                <path fill-rule="evenodd" d="M2.5 11.5A.5.5 0 0 1 3 11h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4A.5.5 0 0 1 3 7h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4A.5.5 0 0 1 3 3h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/>
                                        </svg>
                                    </button>
                                ...
                                <!-- créer question --> 
                                <li class="nav-item">
                                    <button value="question" class="bg-info ml-3 nav">
                                        <svg class="bi bi-file-plus" width="60px" height="60px" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9 1H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V8h-1v5a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h5V1z"/>
                                            <path fill-rule="evenodd" d="M13.5 1a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1H13V1.5a.5.5 0 0 1 .5-.5z"/>
                                            <path fill-rule="evenodd" d="M13 3.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0v-2z"/>
            ...
            <div class="col-3 m-auto">
                <button type="submit" class="btn btn-info ml-5 p-2">
                    <a class="text-white" id="btn_deconnect"  style="text-decoration:none;" 
...
$(document).ready(
 function(){
     $('.nav').on(
             'click',
             () => {
                $this = $('.nav')[2].value, action = 'admin';
                $('#admin').load('pages/'+$this+'.php');
                //  $.ajax({
                //     url:'test.php',
                //     type: 'post',
                //     dataType: 'text',
